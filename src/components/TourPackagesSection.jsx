...
function PackageCard({ pkg }) {
  return (
    <div className="rounded-2xl bg-brandYellow/95 text-brandBlack p-10 flex flex-col shadow-[0_4px_20px_-4px_rgba(0,0,0,0.15)] relative overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center mb-8">
        <div className="w-14 h-14 rounded-xl bg-black text-brandYellow grid place-items-center mb-4 shadow-inner">
          <i className="fa-solid fa-taxi text-2xl" aria-hidden="true" />
        </div>
        <h3 className="text-sm font-extrabold uppercase tracking-[1px] leading-snug max-w-[240px]">
          {pkg.title}
        </h3>
        <p className="text-[10px] font-medium mt-3 tracking-wide">
          {pkg.timing}
        </p>
      </div>

      <div className="grid grid-cols-2 gap-x-8 gap-y-3 mb-8 border-y border-black/15 py-6 text-[11px]">
        {pkg.spots.map((s) => (
          <SpotItem key={s.label} spot={s} />
        ))}
      </div>

      <div className="flex flex-col gap-5 text-[11px] font-semibold tracking-wider mb-8">
      ...
      <div className="mt-auto">
        <button
          type="button"
          className="w-full rounded-full bg-brandBlack hover:bg-black text-white text-[11px] font-semibold tracking-wide py-4 transition-colors"
        >
          Order Taxi Now
        </button>
      </div>
...
export default function TourPackagesSection() {
  return (
    <section
      id="packages"
      className="bg-white py-28 px-6 lg:px-10 text-brandBlack"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-center mb-20">
        ...
        <p className="mt-20 text-center text-[10px] leading-relaxed tracking-wide text-brandBlack/70 max-w-5xl mx-auto">
